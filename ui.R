...
shinyUI(fluidPage(theme = shinytheme("readable"), 
                  ...
                  sidebarLayout(
                    sidebarPanel(
                      ...
                      div(style="display:inline-block ; color:#006600", checkboxInput("H5N1_s", "H5N1", value = FALSE)),  
                      div(style="display:inline-block", checkboxInput("SOV", "Show unselected viruses that also occur on nodes in this network?", value = FALSE)),  
                      if(6 > 0) {
